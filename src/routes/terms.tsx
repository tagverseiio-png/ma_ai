      ...
      <Section>
        ...
        >
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">1. Acceptance of terms</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">2. Services</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">3. Intellectual property</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">4. Use of the site</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">5. Limitation of liability</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">6. Termination</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">7. Governing law</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">8. Changes to terms</h2>
            <p className="leading-relaxed">
