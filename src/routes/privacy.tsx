      ...
      <Section>
        ...
        >
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">1. Information we collect</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">2. How we use information</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">3. Cookies and tracking</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">4. Data security</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">5. Third-party services</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">6. Your rights</h2>
            <p className="leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[var(--site-fg)]">7. Updates to this policy</h2>
            <p className="leading-relaxed">
